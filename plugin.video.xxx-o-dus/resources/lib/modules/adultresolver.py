...
class updater:
    ...
    def __init__(self):
        ...
        self.resolver_check_set = kodi.get_setting('resolver_check')
    ...
    def check_resolver(self):
        ...
        try:
            if self.resolver_check_set == 'true':
                r = client.request(base64.b64decode('aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL3hpYmFsYmExMC9wbHVnaW4udmlkZW8ueHh4LW8tZHVzL21hc3Rlci9yZXNvdXJjZXMvbGliL21vZHVsZXMvYWR1bHRyZXNvbHZlci5weQ=='))
            else:
                r = cache.get(client.request, 4, base64.b64decode('aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL3hpYmFsYmExMC9wbHVnaW4udmlkZW8ueHh4LW8tZHVzL21hc3Rlci9yZXNvdXJjZXMvbGliL21vZHVsZXMvYWR1bHRyZXNvbHZlci5weQ=='))
            if len(r)>1:
